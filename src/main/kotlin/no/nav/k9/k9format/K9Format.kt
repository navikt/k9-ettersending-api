...
private fun Søknadstype.tilK9Ytelse(): Ytelse {
    return when(this){
        Søknadstype.OMP_UTV_KS, Søknadstype.OMP_DELE_DAGER -> Ytelse.OMP_UTV_KS //TODO 26.04.2021 - Hvis dette skal inn i nytt K9-format før dele-dager blir tatt ut til årskvantum burde det lages egen Ytelse
